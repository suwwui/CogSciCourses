...
if($op == 'delete'){
    $id = $_GET['id'];
    $sql1 = "delete from y2s2 where id = '$id'";
...
if($op == 'edit'){
    $id = $_GET['id'];
    $sql1 = "select * from y2s2 where id = '$id'";
    $q1 = mysqli_query($connect, $sql1);
...
if (isset($_POST['save'])) { // to create new data
    ...
    if ($code && $subject && $credit && $status) {
        if($op == 'edit'){ //update data
            $sql1 = "update y2s2 set code = '$code', subject = '$subject', credit = '$credit', status = '$status' where id = '$id'";
            $q1 = mysqli_query($connect, $sql1);
            if($q1){
            ...
            $sql1 = "insert into y2s2(code,subject,credit,status) values('$code','$subject','$credit','$status')";
        $q1 = mysqli_query($connect, $sql1);
        if ($q1) {
    ...
    <a class="btn btn-primary" href="../pages/year2.html" role="button">Back</a>
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <?php
                    header("refresh:5;url=four.php"); // 5 seconds
                }
                ?>
                <?php
                if ($success) {
        ...
        <div class="card">
            ...
            <div class="card-body">
                <table class="table">
                    ...
                    <tbody>
                        <?php
                        $sql2 = "select * from y2s2 order by id desc";
                        ...
                        ?>
                            <tr>
                                ...
                                <td scope="row">
                                    <a href="four.php?op=edit&id=<?php echo $id?>"><button type="button" class="btn btn-warning">Edit</button></a>
                                    <a href="four.php?op=delete&id=<?php echo $id?>" onclick="return confirm('Are you sure you want to delete this data?')"><button type="button" class="btn btn-danger">Delete</button></a>
