...
if($op == 'delete'){
    $id = $_GET['id'];
    $sql1 = "delete from y1s1 where id = '$id'";
...
if($op == 'edit'){
    $id = $_GET['id'];
    $sql1 = "select * from y1s1 where id = '$id'";
    $q1 = mysqli_query($connect, $sql1);
...
if (isset($_POST['save'])) { // to create new data
    ...
    if ($code && $subject && $credit && $status) {
        if($op == 'edit'){ //update data
            $sql1 = "update y1s1 set code = '$code', subject = '$subject', credit = '$credit', status = '$status' where id = '$id'";
            $q1 = mysqli_query($connect, $sql1);
            if($q1){
            ...
            $sql1 = "insert into y1s1(code,subject,credit,status) values('$code','$subject','$credit','$status')";
        $q1 = mysqli_query($connect, $sql1);
        if ($q1) {
...
<body>
            ...
            <ul class="navbar-nav">
              <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle" href="#" id="navbarDarkDropdownMenuLink" 
                 role="button" data-bs-toggle="dropdown" aria-expanded="false">Courses
                </a>
    ...
    <div class="mx-auto">
      ...
      <a class="btn btn-primary" href="../pages/year1.html" role="button">Back</a>
        <!-- to insert data -->
        <div class="card">
            ...
            <div class="card-body">
                ...
                <?php
                    header("refresh:5;url=one.php"); // 5 seconds
                }
                ?>
                <?php
                if ($success) {
        ...
        <div class="card">
            ...
            <div class="card-body">
                <table class="table">
                    ...
                    <tbody>
                        <?php
                        $sql2 = "select * from y1s1 order by id desc";
                        ...
                        ?>
                            <tr>
                                ...
                                <td scope="row">
                                    <a href="one.php?op=edit&id=<?php echo $id?>"><button type="button" class="btn btn-warning">Edit</button></a>
                                    <a href="one.php?op=delete&id=<?php echo $id?>" onclick="return confirm('Are you sure you want to delete this data?')"><button type="button" class="btn btn-danger">Delete</button></a>
